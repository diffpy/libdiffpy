...
class TestBVParametersTable : public CxxTest::TestSuite {
 ...
 public:
  void setUp() { mbvtb.reset(new BVParametersTable); }
  ...
  void test_lookup() {
    ...
    TS_ASSERT_EQUALS(&mbvtb->lookup(bk), &mbvtb->lookup("Cl", -1, "Na", 1));
  ...
  void test_serialization() {
    ...
    TS_ASSERT_EQUALS(2.345, bvtb1->lookup("Cl", -1, "Na", 1).mRo);
    TS_ASSERT_EQUALS(0.44, bvtb1->lookup("Cl", -1, "Na", 1).mB);
    TS_ASSERT_EQUALS(string("pj1"), bvtb1->lookup("Cl", -1, "Na", 1).mref_id);
    TS_ASSERT_EQUALS(3.456, bvtb1->lookup("O", -2, "Mg", 2).mRo);
    TS_ASSERT_EQUALS(0.55, bvtb1->lookup("O", -2, "Mg", 2).mB);
    TS_ASSERT_EQUALS(string("pj2"), bvtb1->lookup("O", -2, "Mg", 2).mref_id);
