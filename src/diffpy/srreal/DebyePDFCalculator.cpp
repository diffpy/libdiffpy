...
DebyePDFCalculator::DebyePDFCalculator()
  ...
  // attributes
  this->registerDoubleAttribute("qmin", this, &DebyePDFCalculator::getQmin,
                                &DebyePDFCalculator::setQmin);
  this->registerDoubleAttribute("qmax", this, &DebyePDFCalculator::getQmax,
                                &DebyePDFCalculator::setQmax);
  this->registerDoubleAttribute("qstep", this, &DebyePDFCalculator::getQstep,
                                &DebyePDFCalculator::setQstep);
  this->registerDoubleAttribute("rmin", this, &DebyePDFCalculator::getRmin,
                                &DebyePDFCalculator::setRmin);
  this->registerDoubleAttribute("rmax", this, &DebyePDFCalculator::getRmax,
                                &DebyePDFCalculator::setRmax);
  this->registerDoubleAttribute("rstep", this, &DebyePDFCalculator::getRstep,
                                &DebyePDFCalculator::setRstep);
...
const double& DebyePDFCalculator::getQmin() const { return mqminpdf; }
...
const double& DebyePDFCalculator::getRstep() const { return mrstep; }
...
double DebyePDFCalculator::extFromTerminationRipples() const {
  ...
  double rv =
    (this->getQmax() > 0.0) ? (nripples * 2 * M_PI / this->getQmax()) : 0.0;
  return rv;
}
