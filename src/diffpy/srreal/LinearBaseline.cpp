...
LinearBaseline::LinearBaseline() {
  this->setSlope(0.0);
  this->registerDoubleAttribute("slope", this, &LinearBaseline::getSlope,
...
void LinearBaseline::setSlope(double sc) { mslope = sc; }

const double& LinearBaseline::getSlope() const { return mslope; }
