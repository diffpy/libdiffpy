...
const R3::Vector& NoMetaStructureAdapter::siteCartesianPosition(int idx) const {
...
StructureDifference NoMetaStructureAdapter::diff(
...
StructureAdapterPtr NoMetaStructureAdapter::getSourceStructure() {
  return msrcstructure;
}

StructureAdapterConstPtr NoMetaStructureAdapter::getSourceStructure() const {
  return msrcstructure;
}
...
StructureAdapterPtr nometa(StructureAdapterPtr stru) {
  StructureAdapterPtr rv =
    boost::dynamic_pointer_cast<NoMetaStructureAdapter>(stru)
      ? stru
