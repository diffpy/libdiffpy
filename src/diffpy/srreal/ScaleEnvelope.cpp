...
ScaleEnvelope::ScaleEnvelope() {
  this->setScale(1.0);
  this->registerDoubleAttribute("scale", this, &ScaleEnvelope::getScale,
                                &ScaleEnvelope::setScale);
}
...
void ScaleEnvelope::setScale(double sc) { mscale = sc; }

const double& ScaleEnvelope::getScale() const { return mscale; }
