...
const char* SFTElectronNumber::mendata_lines[] = {
    ...
    "Sc 21 -3 +3",
    "Ti 22 -4 -3 -2 +2 +3 +4 +9",
    "V 23 -5 -3 -2 +1 +2 +3 +4 +5 +9",
    "Cr 24 -3 -2 +2 +3 +4 +5 +6 +9",
    "Mn 25 -4 -3 -2 +2 +3 +4 +6 +7 +9",
    "Fe 26 -3 -2 +2 +3 +4 +6 +9",
    "Co 27 -3 -2 -1 +1 +2 +3 +4 +9",
    "Ni 28 -3 -2 +2 +3 +4 +9",
    "Cu 29 -2 -1 +1 +2 +3",
    "Zn 30 -2 +2",
    "Ga 31 -3 +1 +3 +9",
    ...
    "Zr 40 -4 +2 +4",
    "Nb 41 -5 -3 +3 +4 +5 +9",
    "Mo 42 -6 -5 -3 +2 +3 +4 +5 +6 +7 +9",
    "Tc 43 +3 +4 +5 +6 +7",
    "Ru 44 -4 -3 +2 +3 +4 +5 +6 +7 +9",
    "Rh 45 -4 -3 +3 +4 +5 +9",
    "Pd 46 -4 -2 +2 +4 +9",
    "Ag 47 -2 -1 +1 +2 +3 +9",
    "Cd 48 -2 +2",
