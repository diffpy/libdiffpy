...
StepCutEnvelope::StepCutEnvelope() {
  this->setStepCut(0.0);
  this->registerDoubleAttribute("stepcut", this, &StepCutEnvelope::getStepCut,
                                &StepCutEnvelope::setStepCut);
}
...
void StepCutEnvelope::setStepCut(double sc) { mstepcut = sc; }

const double& StepCutEnvelope::getStepCut() const { return mstepcut; }
