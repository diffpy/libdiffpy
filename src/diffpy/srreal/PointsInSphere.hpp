...
class LatticeParameters {
 public:
  ...
  // constructor
  LatticeParameters(double _a, double _b, double _c, double _alpha,
...
class PointsInSphere {
 public:
  ...
  PointsInSphere(double rmin, double rmax, double _a, double _b, double _c,
...
class ReflectionsInQminQmax {
 public:
  ...
  ReflectionsInQminQmax(double _Qmin, double _Qmax,
                        const pointsinsphere::LatticeParameters& _latpar);
  ReflectionsInQminQmax(double _Qmin, double _Qmax, double _a, double _b,
                        double _c, double _alpha, double _beta, double _gamma);
  template <class L>
...
class ReflectionsInDmaxDmin : public ReflectionsInQminQmax {
 public:
  ...
  ReflectionsInDmaxDmin(double dmax, double dmin,
                        const pointsinsphere::LatticeParameters& _latpar);
  ReflectionsInDmaxDmin(double dmax, double dmin, double _a, double _b,
                        double _c, double _alpha, double _beta, double _gamma);
  template <class L>
