...
bool ScatteringFactorTable::registerThisType() const {
  ...
  rv =
    rv && ScatteringFactorTable::aliasType(this->type(), this->radiationType());
  return rv;
}
...
void ScatteringFactorTable::setCustomAs(const string& smbl,
                                        const string& srcsmbl) {
...
void ScatteringFactorTable::setCustomAs(const string& smbl,
                                        const string& srcsmbl, double value,
                                        double q) {
