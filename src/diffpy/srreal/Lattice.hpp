...
class Lattice {
 public:
  ...
  Lattice();
  Lattice(double a, double b, double c, double alpha, double beta,
          double gamma);
  ...
  void setLatPar(double a, double b, double c, double alpha, double beta,
                 double gamma);
  // set lattice base vectors
  void setLatBase(const R3::Vector& va, const R3::Vector& vb,
                  const R3::Vector& vc);
  template <class V>
...
inline double Lattice::a() const { return ma; }

inline double Lattice::b() const { return mb; }

inline double Lattice::c() const { return mc; }

inline double Lattice::alpha() const { return malpha; }

inline double Lattice::beta() const { return mbeta; }

inline double Lattice::gamma() const { return mgamma; }

inline double Lattice::cosalpha() const { return mcosa; }

inline double Lattice::cosbeta() const { return mcosb; }

inline double Lattice::cosgamma() const { return mcosg; }

inline double Lattice::sinalpha() const { return msina; }

inline double Lattice::sinbeta() const { return msinb; }

inline double Lattice::singamma() const { return msing; }

inline const R3::Vector& Lattice::va() const { return mva; }

inline const R3::Vector& Lattice::vb() const { return mvb; }

inline const R3::Vector& Lattice::vc() const { return mvc; }

// reciprocal lattice

inline double Lattice::ar() const { return mar; }

inline double Lattice::br() const { return mbr; }

inline double Lattice::cr() const { return mcr; }

inline double Lattice::alphar() const { return malphar; }

inline double Lattice::betar() const { return mbetar; }

inline double Lattice::gammar() const { return mgammar; }

inline double Lattice::cosalphar() const { return mcosar; }

inline double Lattice::cosbetar() const { return mcosbr; }

inline double Lattice::cosgammar() const { return mcosgr; }

inline double Lattice::sinalphar() const { return msinar; }

inline double Lattice::sinbetar() const { return msinbr; }

inline double Lattice::singammar() const { return msingr; }

inline const R3::Vector& Lattice::var() const { return mvar; }

inline const R3::Vector& Lattice::vbr() const { return mvbr; }

inline const R3::Vector& Lattice::vcr() const { return mvcr; }

// lattice related tensors

inline const R3::Matrix& Lattice::metrics() const { return mmetrics; }

inline const R3::Matrix& Lattice::base() const { return mbase; }

inline const R3::Matrix& Lattice::stdbase() const { return mstdbase; }

inline const R3::Matrix& Lattice::baserot() const { return mbaserot; }

inline const R3::Matrix& Lattice::recbase() const { return mrecbase; }

template <class V>
double Lattice::dot(const V& u, const V& v) const {
  const R3::Matrix& M = this->metrics();
  double dp = u[0] * v[0] * M(0, 0) + u[1] * v[1] * M(1, 1) +
              u[2] * v[2] * M(2, 2) + (u[0] * v[1] + u[1] * v[0]) * M(0, 1) +
