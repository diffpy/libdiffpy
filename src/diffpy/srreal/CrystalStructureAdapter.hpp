...
inline bool operator==(const SymOpRotTrans& op0, const SymOpRotTrans& op1) {
...
class DLL_EXPORT CrystalStructureAdapter : public PeriodicStructureAdapter {
 ...
 private:
  ...
  // comparison
  friend DLL_EXPORT bool operator==(const CrystalStructureAdapter&,
...
class DLL_EXPORT CrystalStructureBondGenerator
    : public PeriodicStructureBondGenerator {
 public:
  // constructors
