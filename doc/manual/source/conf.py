...
# -*- coding: utf-8 -*-
#
# libdiffpy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'libdiffpy.tex', u'libdiffpy Documentation',
   ab_authors, 'manual'),
]
...
man_pages = [
    ('index', 'libdiffpy', u'libdiffpy Documentation',
     ab_authors, 1)
]
...
texinfo_documents = [
  ('index', 'libdiffpy', u'libdiffpy Documentation',
   ab_authors, 'libdiffpy', 'One line description of project.',
   'Miscellaneous'),
]
